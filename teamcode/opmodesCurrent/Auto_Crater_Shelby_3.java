...
//@Autonomous(name = "Auto Crater Shelby 3")

public class Auto_Crater_Shelby_3 extends LinearOpMode {
    ...
    public void runOpMode() {
       ...
       /* parameters.vuforiaLicenseKey = "AYNyvIr/////AAAAGab/vxrDZkmikc0DLSgRj7kjE9EJpHUguaSu4fsW" +
        ...
        if (opModeIsActive() && this.time <= (29.5 + gameTimeSnapShot)) {                  //limits code to 30 seconds
            ...
            //sleep(500);
            encoderDrive(3, 1, 6, 6, 0, true);// was strafe 3.125
            //strafe off hook
            //encoderDrive(2,1,-2,-2,0,false);
            //sleep(250);
            encoderDrive(3,1,5,5,0,false);
            //drive away from lander
            encoderDrive(4,1,-6,-6,0,true);
            //correct strafe
            encoderDrive(5,0.35,10,10,0,false);


            encoderDrive(5,0.35,-17,17,0,false);//was turning 18
            //turn to face depot
            encoderDrive(8,0.5,45,45,-4,false);
            //drive to depot

            encoderDrive(3,0.35,-7.5,7.5,0,false);//was turning 9
            //turn to depot
            encoderDrive(8,0.5,40,40,-3,false);
