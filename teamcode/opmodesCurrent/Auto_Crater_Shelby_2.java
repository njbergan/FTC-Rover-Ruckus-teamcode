...
//@Autonomous(name = "Auto Crater Shelby 2")

public class Auto_Crater_Shelby_2 extends LinearOpMode {
    ...
    public void runOpMode() {
       ...
       /* parameters.vuforiaLicenseKey = "AYNyvIr/////AAAAGab/vxrDZkmikc0DLSgRj7kjE9EJpHUguaSu4fsW" +
        ...
        if (opModeIsActive() && this.time <= 29.5) {                  //limits code to 30 seconds
            ...
            encoderDrive(3, 1, 0, 0, 8, false);  //was commented out:1-4
        //drop
            encoderDrive(4, .35, 3.5, 3.5, 0, true); //:2
        //strafe off hook
            encoderDrive(5.5, .35, 15, 15, 0, false); //:3
        //drive towards crater
            encoderDrive(7, .35, 66, 66, 0, true); //:4-end of comment out
        //strafe towards wall
