...
//@Autonomous(name = "Auto Crater Shelby")

public class Auto_Crater_Shelby extends LinearOpMode {
    ...
    private static final double CPI_DRIVE_TRAIN = 560 / (Math.PI * 4.75),
    ...
    public void runOpMode() {
       ...
       /* parameters.vuforiaLicenseKey = "AYNyvIr/////AAAAGab/vxrDZkmikc0DLSgRj7kjE9EJpHUguaSu4fsW" +
        ...
        if (opModeIsActive() && this.time <= 29.5) {                  //limits code to 30 seconds
            ...
            //encoderDrive(6,1,0,0,7,false);

            //encoderDrive(4,.35,3.5,3.5,0,true);

            //encoderDrive(5.5,.35,15,15,0,false);

            //encoderDrive(7,.35,66,66,0,true);

            encoderDrive(2.5, .35, -10, -10, 0, true);

            encoderDrive(6, .35, 44, -44, 0, false);

            encoderDrive(6,1,48,48,0,false);
        }
    }
