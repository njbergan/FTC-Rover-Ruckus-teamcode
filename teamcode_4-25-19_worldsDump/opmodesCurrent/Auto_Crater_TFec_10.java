...
//@Autonomous(name = "Auto Crater 10")

public class Auto_Crater_TFec_10 extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        if (opModeIsActive() && this.time <= (27.5 + gameTimeSnapShot)) {                  //limits code to 30 seconds
            ...
            if (goldSample == 3) {  //1: left, 2: center, 3: right, -1: unknown
                ...
                encoderDrive(2, 0.35,0.35,0, -17, 17, 0, 0, 0, false);//18
                ...
                //backup to straighten
                encoderDrive(2.5, 0.25, 0.36, 0, 200, 240, 0, 0, 0, false);
                servoCrFlapper.setPower(-1);
                sleep(2000);
                encoderDrive(7, 0.25, 0.25, 1, -68, -68, -4.0, 0, 0, false);
