...
//@Autonomous(name="Auto Depot Shelby")

public class Auto_Depot_Shelby extends LinearOpMode {
    ...
    //logical robot movements based on encoders
            ...
            if (opModeIsActive() && this.time <= 29.5) {                  //limits code to 30 seconds
               ...
               // telemetry.addData("VuMark", "%s visible", vuMark);
                ...
                encoderDrive(5, 1, 0, 0, 7, false);
                encoderDrive(5, .35, 3.125, 3.125, 0, true);
                encoderDrive(5, .35, 50, 40, 0, false);
                encoderDrive(5, .35, -15, -15, 0, false);
                encoderDrive(6, .35, 20, 20, -7, false);
            }
               /* relicTrackables.deactivate();
                drive(0,0);
