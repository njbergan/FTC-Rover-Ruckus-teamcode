...
//@Autonomous(name = "Auto Depot 7")

public class Auto_Depot_Shelby_7 extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        if (opModeIsActive() && this.time <= (29.5 + gameTimeSnapShot)) {                  //limits code to 30 seconds
            ...
            encoderDrive(6.3, 0.35, 49, 49, 0,0,0, false);//was 50L,40R
            servoCrFlapper.setPower(-1);
            sleep(1500);


            encoderDrive(5,0.35,-29,-29,-0.75,0,0,false);//26
            //backup past samples towards lander
            servoCrFlapper.setPower(0);

            encoderDrive(3,0.5,14,-14,-0.25,0,0,false);//14
            //turn to backface opponent crater
            encoderDrive(8,0.3,-53,-53,-7,0,0,false);//53,51
