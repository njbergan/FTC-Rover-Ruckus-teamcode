...
//@Autonomous(name = "Auto Crater DEMO")//lists this file as an Opmode to the phone as the name in quotes

public class Auto_Crater_DEMO_13 extends LinearOpMode {
        ...
        *Now you see what the robot see's, what a headache!
        ...
        if (opModeIsActive() && this.time <= (27.5 + gameTimeSnapShot) && !isStopRequested()) {
            ...
            encoderDrive(5.5, 0,0,1, 0, 0,
                    8, 0, 0, false);//was lift 7, 7.5, timeont 7.3
            //drop
