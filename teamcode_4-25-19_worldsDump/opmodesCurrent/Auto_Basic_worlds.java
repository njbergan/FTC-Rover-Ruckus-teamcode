...
@Autonomous(name = "Auto BASIC worlds")//lists this file as an Opmode to the phone as the name in quotes

public class Auto_Basic_worlds extends LinearOpMode {
    ...
    */
    ...
    public void runOpMode() {
        ...
        *Now you see what the robot see's, what a headache!
        ...
        while (opModeIsActive() && this.time <= (27.5 + gameTimeSnapShot) && !isStopRequested()) {
            ...
            motorSetModes(DcMotor.RunMode.RUN_WITHOUT_ENCODER);
            drive(0, 0);
            motorLift.setPower(0);



            if (opModeIsActive() && !isStopRequested() && this.time >= (0.5 + gameTimeSnapShot) && this.time <= (3.5 + gameTimeSnapShot)) {
    ...
    public void encoderDrive(double timeOut, double leftDTSpeed, double rightDTSpeed, double auxSpeed, double mtrLeftInches, double mtrRightInches,
        ...
        if (opModeIsActive()) {
            ...
            //        newMtrShoulderTarget, newMtrRailTarget,
            //        strafeVar);
