...
public class Auto_Crater_TFeci_14 extends LinearOpMode {
        ...
        *Now you see what the robot see's, what a headache!
        ...
        if (opModeIsActive() && this.time <= (27.5 + gameTimeSnapShot) && !isStopRequested()) {
            ...
            if (goldSample == 3) {  //1: left, 2: center, 3: right, -1: unknown
                encoderDrive(0.85, 0.52,0.15,0, 180, 60, 0, 0, 0, false);//0.15,0.45,15",45"
                    //s0.9  L52
                sleep(100);
                encoderDrive(0.55, 0.52,0.15,0, -180, -60, 0, 0, 0, false);//0.15,0.45,15",45"
                    //s0.5
                sleep(250);
                encoderDrive(2, 0.35,0.35,0, -18.5, 18.5, 0, 0, 0, false);//18
                    ///L-16.75,19,20,19
                //encoderDrive(2.4, 0.28, 0.40, 0, 200, 240, 0, 0, 0, false);
                    //R37,47,37,39,35. L25  s2.5
                sleep(250);
                encoderDrive(1.9, 0.25,0.4,0, 60, 180, 0, 0, 0, false);//0.15,0.45,15",45"
                sleep(100);     //timeout 1.75,1.85     L25     R40
                encoderDrive(2, 0.4, 0.4, 0, 18, 18, 0, 0, 0, false);
                                //TO2       "12
                ...
                encoderDrive(2, 0.3, 0.3, 0, 21, 21, 0, 0, 0, false);//25"
                ...
                //turn left
                encoderDrive(2, 0.27, 0.41, 0, 200, 240, 0, 0, 0, false);
                motorFlapper.setPower(-0.5);        //LdtS 25, RdtS 36, Seconds2.5,2.3
                sleep(2000);
                //encoderDrive(5, 0.25, 0.25, 1, -70, -70, -4.0, 0, 0, false);
                encoderDrive(5, 0.25, 0.25, 1, -63, -63, 0, 0, 0, false);
                                                //-70,-68,-65
                //mtrLeft 68, mtrRight 68
            } else {
            //} else if (goldSample == 1) {
                encoderDrive(0.8, 0.15,0.52,0, 60, 180, 0, 0, 0, false);//0.15,0.45,15",45"
                //s0.9, 0.85  L52
                sleep(100);
                encoderDrive(0.5, 0.15,0.52,0, -60, -180, 0, 0, 0, false);//0.15,0.45,15",45"
                //s0.5, 0.55
                sleep(250);
                encoderDrive(2, 0.35,0.35,0, -10.5, 10.5, 0, 0, 0, false);//18
                ///R11
                //encoderDrive(2.4, 0.28, 0.40, 0, 200, 240, 0, 0, 0, false);
                //R37,47,37,39,35. L25  s2.5
                sleep(250);
                encoderDrive(1.9, 0.25,0.41,0, 60, 180, 0, 0, 0, false);//0.15,0.45,15",45"
                sleep(100);     //timeout 1.75,1.85     L25     R40
                encoderDrive(2, 0.4, 0.4, 0, 12, 12, 0, 0, 0, false);
                //TO2       "12
                motorFlapper.setPower(-0.5);
                sleep(2000);
                //encoderDrive(5, 0.25,0.25,1, -68, -68, -4.0, 0, 0, false);
