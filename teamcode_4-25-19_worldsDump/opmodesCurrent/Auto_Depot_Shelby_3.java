...
//@Autonomous(name = "Auto Depot Shelby 3")

public class Auto_Depot_Shelby_3 extends LinearOpMode {
    ...
    public void runOpMode() {
       ...
       /* parameters.vuforiaLicenseKey = "AYNyvIr/////AAAAGab/vxrDZkmikc0DLSgRj7kjE9EJpHUguaSu4fsW" +
        ...
        if (opModeIsActive() && this.time <= (29.5 + gameTimeSnapShot)) {                  //limits code to 30 seconds
            ...
            encoderDrive(7, 0.35, 40, 40, -6, false);//was 50L,40R
            servoMarker.setPosition(1);
            sleep(1000);


            encoderDrive(5,0.5,-30,-30,0,false);
