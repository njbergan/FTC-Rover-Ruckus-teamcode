...
//@Autonomous(name = "Auto Depot 10")

public class Auto_Depot_TFec_10 extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        if (opModeIsActive() && this.time <= (27.5 + gameTimeSnapShot)) {                  //limits code to 30 seconds
            ...
            if (goldSample == 3) {  //1: left, 2: center, 3: right, -1: unknown
                ...
                encoderDrive(1.5, 0.07,0.65,0, 60, 180,0, 0, 0, false);//0.95seconds,1.5
                ...
                servoCrFlapper.setPower(-1);//run the flapper
                sleep(2000);
