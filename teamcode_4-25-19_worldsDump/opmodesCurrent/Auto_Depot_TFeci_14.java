...
@Autonomous(name = "Auto Depot 14")

public class Auto_Depot_TFeci_14 extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        if (opModeIsActive() && this.time <= (27.5 + gameTimeSnapShot) && !isStopRequested()) {                  //limits code to 30 seconds
            ...
            //contract actuator to halfway      -4" lift
            ...
            if (goldSample == 3) {  //1: left, 2: center, 3: right, -1: unknown
                encoderDrive(0.83, 0.52,0.13,0, 180, 60, 0, 0, 0, false);//0.15,0.45,15",45"
                //s0.9  L52     R15
                sleep(250);
                encoderDrive(0.52, 0.52,0.13,0, -180, -60, 0, 0, 0, false);//0.15,0.45,15",45"
                //s0.5
                sleep(250);
                encoderDrive(2, 0.35,0.35,0, -20, 20, 0, 0, 0, false);//18
                ///L-16.75,19,20,19, 18.5
                sleep(250);
                encoderDrive(1, 0.4, 0.4, 0, 12, 12, 0, 0, 0, false);
                sleep(100);
                encoderDrive(1.2, 0.5, 0.05, 0, 200, 200, 0, 0, 0, false);
                encoderDrive(2, 0.3, 0.3, 0, 18, 18, 0, 0, 0, false);
                ...
                encoderDrive(5, 0.25,0.25,1, -64, -64, 0, 0, 0, false);
                        //L-68
            ...
            //} else if (goldSample == 1) {
                ...
                encoderDrive(0.83, 0.13,0.52,0, 60, 180, 0, 0, 0, false);//0.15,0.45,15",45"
                //s0.9  L52     R15
                sleep(250);
                encoderDrive(0.52, 0.13,0.52,0, -60, -180, 0, 0, 0, false);//0.15,0.45,15",45"
                //s0.5
                sleep(250);
                encoderDrive(2, 0.35,0.35,0, -12, 12, 0, 0, 0, false);//18
                ///L 20
                sleep(250);
                encoderDrive(1, 0.4, 0.4, 0, 12, 12, 0, 0, 0, false);
                sleep(100);
                encoderDrive(1.2, 0.5, 0.05, 0, 200, 200, 0, 0, 0, false);
                encoderDrive(2, 0.3, 0.3, 0, 21, 21, 0, 0, 0, false);
                ...
                encoderDrive(5, 0.25,0.3,1, -67, -69, 0, 0, 0, false);
                //L-68
                motorFlapper.setPower(0);
