...
//@TeleOp(name = "TFec_65%")  //blocks to java
public class TFec65percentRecog extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        vuforiaRoverRuckus.initialize("", hardwareMap.get(WebcamName.class, "Webcam1"), "teamwebcamcalibrationLive.xml",
                ...
                0, 0, 0, 0, 0, 0, true);
        tfodRoverRuckus.initialize(vuforiaRoverRuckus, 0.65f, true, true);
        ...
        if (opModeIsActive()) {
            ...
            // Put run blocks here.
            while (opModeIsActive() && (this.time < 6)) {
                telemetry.addLine("# Object");
